...
1b. **Na primeira avaliação de cada sessão:** Executar `npm run sync-check` via Bash. Se houver avisos, informar o candidato antes de continuar
...
| Bash | `npm run pdf --`, `npm run merge` |
