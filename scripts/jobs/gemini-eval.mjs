 ...
 *
 * Usage:
 *   node scripts/jobs/gemini-eval.mjs "Paste full JD text here"
 *   node scripts/jobs/gemini-eval.mjs --file ./jds/my-job.txt
 *
 * Requires:
...
╚══════════════════════════════════════════════════════════════════╝
  ...
  USAGE
    node scripts/jobs/gemini-eval.mjs "<JD text>"
    node scripts/jobs/gemini-eval.mjs --file ./jds/my-job.txt
    node scripts/jobs/gemini-eval.mjs --model gemini-2.0-flash "<JD text>"
  ...
  EXAMPLES
    node scripts/jobs/gemini-eval.mjs "We are looking for a Senior AI Engineer..."
    node scripts/jobs/gemini-eval.mjs --file ./jds/openai-swe.txt
`);
  process.exit(0);
}
