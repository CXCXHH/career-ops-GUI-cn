...
function checkCv() {
  ...
  if (existsSync(join(projectRoot, 'templates', 'cv.example.md'))) {
    return { pass: true, label: 'cv.md not found (template available)' };
  }
  return {
    pass: true,
    label: 'cv.md not found (optional in desensitized mode)',
  };
}
...
function checkPortals() {
  ...
  if (existsSync(join(projectRoot, 'templates', 'portals.example.yml'))) {
    return { pass: true, label: 'portals.yml not found (template available)' };
  }
  return {
    pass: true,
    label: 'portals.yml not found (optional in desensitized mode)',
  };
}
